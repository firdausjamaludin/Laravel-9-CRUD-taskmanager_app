            ...
            <form>
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="">
                        ...
                        <div class="mb-4">
                            <label for="exampleFormControlInput2" class="block text-gray-700 text-sm font-bold mb-2">Task:</label>
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-control" id="exampleFormControlInput4" wire:model="status">
